        ...
        <div class="container">
            ...
            <div class="ht-right">
                ...
                <div class="top-social">
                    <a href="https://www.facebook.com/minhleanh1206"><i class="ti-facebook"></i></a>
                    <a href="https://www.instagram.com/mlahh.4/"><i class="ti-twitter"></i></a>
            ...
            <div class="nav-depart">
                <div class="depart-btn">
                    ...
                    <ul class="depart-hover">
                        <li class="active"><a href="./shop">Women's Clothing</a></li>
                        <li><a href="./shop">Men's Clothing </a></li>
                        <li><a href="./shop">UnderWear</a></li>
                        <li><a href="./shop">Kid's Clothing</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <div class="footer-social">
                        <a href="https://www.facebook.com/minhleanh1206" > <i class="fa fa-facebook"></i></a>
                        <a href="https://www.instagram.com/mlahh.4/" > <i class="fa fa-instagram"></i></a>
                        <a href="https://www.instagram.com/mlahh.4/" > <i class="fa fa-twitter"></i></a>
                        <a href="https://www.instagram.com/mlahh.4/" > <i class="fa fa-pinterest"></i></a>
            ...
            <div class="col-lg-2">
                <div class="footer-widget">
                    <h5>My Account</h5>
                    <ul>
                        <li><a href="./cart">My Account</a></li>
                        <li><a href="./checkout">Checkout</a></li>
                        <li><a href="./cart">Shopping Cart</a></li>
