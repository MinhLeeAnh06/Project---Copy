                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="{{Auth::user()->avatar ?? 'default-avatar.jpg'}}"
                                             alt="">
                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="./admin/statistical"  class="{{(request()->segment(2) =='statistical')?'mm-active':''}}">
...
<script src="    <!-- Bootstrap core JavaScript-->
...
<script src="js/demo/chart-pie-demo.js"></script>scripts/jquery-3.2.1.min.js"></script>
